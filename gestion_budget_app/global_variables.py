pourcentage_cat_autres = 0.02
pourcentage_affichage_label_pie_chart = 0.1
source_of_truth = str()

save_file = "/home/thiran/projets_persos/gestion_budget/src/gestion_budget_app/save.txt"

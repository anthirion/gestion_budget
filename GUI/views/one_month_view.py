...
class OneMonthView(QWidget):
    ...
    transactions, les transactions pouvant être des dépenses, revenus ou de
    l'épargne en fonction du sous-menu sélectionné depuis le menu latéral.
    ...
    def __init__(self, parent_widget, transaction_type):
        ...
        Cette classe construit le widget correspondant à la vue sur un
        mois, qui contient:
